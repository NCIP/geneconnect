...
<!ELEMENT Gene-source_gene-display (%BOOLEAN;)> <!-- do we have a URL for gene display?  -->
<!ATTLIST Gene-source_gene-display value ( true | false ) "false" >

<!ELEMENT Gene-source_locus-display (%BOOLEAN;)> <!-- do we have a URL for map/locus display?  -->
<!ATTLIST Gene-source_locus-display value ( true | false ) "false" >

<!ELEMENT Gene-source_extra-terms (%BOOLEAN;)> <!-- do we have a URL for extra indexing terms?  -->
