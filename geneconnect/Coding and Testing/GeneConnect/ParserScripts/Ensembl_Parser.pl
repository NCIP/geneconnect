...
print ensg_enstr "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLGENE_ENSEMBLTRANS_U FIELDS TERMINATED BY '###' (ESN_ENSBLGENEID, ESN_ENSBLTRANSCRIPTID, ESN_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print enstr_enspep "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLTRANS_ENSEMBLPROT_U FIELDS TERMINATED BY '###' (ESP_ENSBLTRANSCRIPTID, ESP_ENSBLPROTEINID, ESP_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print ensg_entg "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLGENE_ENTREZGENE_U FIELDS TERMINATED BY '###' (ESE_ENSEMBLGENEID, ESE_GENEID, ESE_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print ensg_ug "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLGENE_UNIGENE_U FIELDS TERMINATED BY '###' (EBU_ENSEMBLGENEID, EBU_UNIGENEID, EBU_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print enstr_rsmrna "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLTRANS_REFSEQMRNA_U FIELDS TERMINATED BY '###' (ESR_ENSBLTRANSCRIPTID, ESR_REFSEQMRNAID, ESR_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print enspep_rsprot "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLPROT_REFSEQPROTEIN_U FIELDS TERMINATED BY '###' (EPR_ENSBLPROTEINID, EPR_REFSEQPROTEINID, EPR_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print enspep_uniprot "LOAD DATA INFILE * APPEND INTO TABLE ENSEMBLPROT_UNIPROT_U FIELDS TERMINATED BY '###' (ESU_ENSBLPROTEINID, ESU_UNIPROTID, ESU_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";

print entg_ensg "LOAD DATA INFILE * APPEND INTO TABLE ENTREZGENE_ENSEMBLGENE_U FIELDS TERMINATED BY '###' (EEG_GENEID, EEG_ENSEMBLGENEID, EEG_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print ug_ensg "LOAD DATA INFILE * APPEND INTO TABLE UNIGENE_ENSEMBLGENE_U FIELDS TERMINATED BY '###' (UEG_UNIGENEID, UEG_ENSEMBLGENEID, UEG_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";

print rsmrna_enstr "LOAD DATA INFILE * APPEND INTO TABLE REFSEQMRNA_ENSEMBLTRANS_U FIELDS TERMINATED BY '###' (RET_REFSEQMRNAID, RET_ENSBLTRANSCRIPTID, RET_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print rsprot_enspep "LOAD DATA INFILE * APPEND INTO TABLE REFSEQPROTEIN_ENSEMBLPROT_U FIELDS TERMINATED BY '###' (REP_REFSEQPROTEINID, REP_ENSBLPROTEINID, REP_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
print uniprot_enspep "LOAD DATA INFILE * APPEND INTO TABLE UNIPROT_ENSEMBLPROT_U FIELDS TERMINATED BY '###' (UEP_UNIPROTKBID, UEP_ENSBLPROTEINID, UEP_LINKTYPE)" . "\n" . "BEGINDATA" . "\n";
