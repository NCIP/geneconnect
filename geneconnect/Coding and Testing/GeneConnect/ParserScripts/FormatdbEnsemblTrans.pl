...
my $propertiesfile ="properties_blastdestnensmbltrans.txt";
...
print ($configParams{BASEDIR});
 ...
 move("$dbname\.nin","$configParams{BASEDIR}");
 move("$dbname\.nhr","$configParams{BASEDIR}");
 move("$dbname\.nsq","$configParams{BASEDIR}");
