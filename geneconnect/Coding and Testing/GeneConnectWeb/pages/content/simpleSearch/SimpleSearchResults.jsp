	...
	<html:form action="/SearchResultView.do">
		...
		<tr height="85%">
			...
			<div id="active_div" class="activeColWithOutFreq"><script>
							...
							//obj.getColumnTemplate().setEvent("onmousedown",message);
							
							
							//link.setAttribute("href",function(i,j) { var row = obj.getSelectionProperty("index"); alert("row " +row);return "/SimpleSearch.do?setid="+myData[row][];});  
							//link.setAttribute("href",function(i,j){alert();});  
