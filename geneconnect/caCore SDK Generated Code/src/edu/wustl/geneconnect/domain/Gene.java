			   ...
			   if(genomicIdentifierSetCollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	edu.wustl.geneconnect.domain.Gene thisIdSet = new edu.wustl.geneconnect.domain.Gene();
			         	...
			         	java.util.Collection resultList = applicationService.search("edu.wustl.geneconnect.domain.GenomicIdentifierSet", thisIdSet);				 
			      ...
			      {
			      	System.out.println("Gene:getGenomicIdentifierSetCollection throws exception ... ...");
			   		ex.printStackTrace(); 
			      }
			   }	
			...
			try{
			   if(messengerRNACollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	edu.wustl.geneconnect.domain.Gene thisIdSet = new edu.wustl.geneconnect.domain.Gene();
			         	thisIdSet.setId(this.getId());
			         	java.util.Collection resultList = applicationService.search("edu.wustl.geneconnect.domain.MessengerRNA", thisIdSet);				 
			...
			try{
			   if(proteinCollection.size() == 0) {}
			      ...
			      try {
				 	...
				 	edu.wustl.geneconnect.domain.Gene thisIdSet = new edu.wustl.geneconnect.domain.Gene();
			         	thisIdSet.setId(this.getId());
			         	java.util.Collection resultList = applicationService.search("edu.wustl.geneconnect.domain.Protein", thisIdSet);				 
