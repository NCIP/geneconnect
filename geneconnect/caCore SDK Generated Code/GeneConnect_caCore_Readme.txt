...
b. From GeneConnect_caCore directory ('src') copy all subfolder viz. 'edu' and 'gov' to the 
   'caCoreSDK base directory\cacoretoolkit\custom\geneconnect'.
c. Generate XMI Annotaions of Object Model using Enterprise Architect.
d. Configure caCore SDK property/configuration files given the XMI file name(generated in step 'c').
   (For more information on configuring caCore SDK please refer to caCore SDK Technical manual).	
e. Execute ant script of caCore SDK.
